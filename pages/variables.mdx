...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variablescover2.jpg"
        alt="Variables cover"
...
- The **top navigation bar** of the **Flow Editor**.
- The **bottom-right corner** of the **Flow Editor**, alongside zoom and instruction buttons.
...
| **ID** | Auto-generated from the Display Name, but you can edit it. |
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/light_mode/variables_manager-search.jpg"
        alt="Send Email action interface on light mode"
        className="rounded-[14px]"
      />
    </div>
...
<div className="hidden dark:block">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables_manager-search.jpg"
        alt="Send Email action interface on dark mode"
        className="rounded-[14px]"
      />
    </div>
