...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-cover.jpg"
        alt="Variables cover"
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-manager.png"
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-simple-placement.png"
        alt="Variable Manager location – Light Mode"
        className="rounded-[14px]"
      />
    </div>
  </Frame>
...
<div className="hidden dark:block">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-simple-placement.png"
        alt="Variable Manager location – Dark Mode"
        className="rounded-[14px]"
      />
    </div>
  </Frame>
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-simple-placement-2.png"
        alt="Accessing the Variable Manager from a text field – Light Mode"
        className="rounded-[14px]"
      />
    </div>
  </Frame>
...
<div className="hidden dark:block">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-simple-placement-2.png"
        alt="Accessing the Variable Manager from a text field – Dark Mode"
        className="rounded-[14px]"
      />
    </div>
  </Frame>
...
<Note>
Some variables are **system-defined and read-only** (shown at the top of the list), you can use them but not edit or delete them. Examples: **Pre-call** — agent name, agent phone number, first name, last name, phone number, email address, call id; **Post-call** — summary, transcript, recording, duration, call time.
</Note>

<Warning>
**Agent Phone Number** (`agentPhoneNumber`) contains the Pearl's own phone line for the current conversation, unlike **Phone Number**, which identifies the customer. It is empty on channels without a phone number, including Telegram and browser Test Chat. An API node does not execute if it references this variable while it is empty.
</Warning>
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-manager-create.png"
        alt="Send Email action interface on light mode"
        className="rounded-[14px]"
      />
    </div>
...
| **Description** _(optional)_ | Explain the purpose or usage of this variable (helps Pearl use it correctly). | Optional · max 1000 chars |
| **Allow Multiple Entries** | Store a list of values of the chosen type (e.g. several dates). | Optional |
| **Reset Every Interaction** | Start this variable empty in every new interaction instead of reusing the value from a previous one. | Optional |

<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-reset-every-interaction.png"
        alt="Reset Every Interaction toggle in the Variables Manager"
        className="rounded-[14px]"
      />
    </div>
  </Frame>
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-manager-create-2.png"
        alt="Variable details form – Light Mode"
        className="rounded-[14px]"
      />
    </div>
  </Frame>
...
<div className="hidden dark:block">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-manager-create-2.png"
        alt="Variable details form – Dark Mode"
        className="rounded-[14px]"
      />
    </div>
  </Frame>
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-manager-create-3.png"
        alt="Send Email action interface on light mode"
        className="rounded-[14px]"
      />
    </div>
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-simple-placement-4.png"
        alt="Send Email action interface on light mode"
        className="rounded-[14px]"
      />
    </div>
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-manager-search.png"
        alt="Send Email action interface on light mode"
        className="rounded-[14px]"
      />
    </div>
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-manager-edit.png"
        alt="Send Email action interface on light mode"
        className="rounded-[14px]"
      />
    </div>
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-manager-delete.png"
        alt="Send Email action interface on light mode"
        className="rounded-[14px]"
      />
    </div>
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-manager-script.png"
        alt="Send Email action interface on light mode"
        className="rounded-[14px]"
      />
    </div>
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-manager-sms-send.png"
        alt="Send Email action interface on light mode"
        className="rounded-[14px]"
      />
    </div>
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-manager-notification.png"
        alt="Send Email action interface on light mode"
        className="rounded-[14px]"
      />
    </div>
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-tree-1.png"
        alt="Conditional branching – Light Mode"
        className="rounded-[14px]"
      />
    </div>
  </Frame>
...
<div className="hidden dark:block">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-tree-1.png"
        alt="Conditional branching – Dark Mode"
        className="rounded-[14px]"
      />
    </div>
  </Frame>
...
<Warning>
  Do not enable **Reset Every Interaction** on a variable you populate from a CSV import or the API: the value you provide is cleared before the call starts.
</Warning>
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-manager-download.png"
        alt="Send Email action interface on light mode"
        className="rounded-[14px]"
      />
    </div>
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/variables-manager-add-lead.png"
        alt="Send Email action interface on light mode"
        className="rounded-[14px]"
      />
    </div>
