...
description: "Build and deploy AI voice agents that handle real phone conversations in 20+ languages."
icon: "house"
---
...
NLPearl is an AI voice agent platform that lets you create, deploy, and manage phone agents capable of handling real conversations — inbound and outbound — at scale.

Built on a native speech-to-speech architecture, Pearl delivers natural, low-latency, full-duplex voice interactions in over 20 languages. No scripts, no rigid IVR trees — just agents that listen, understand, and act.
...
| Use Case | Description |
|---|---|
| **Outbound Sales & Prospecting** | Call leads, qualify prospects, pitch your offer, and book meetings — without manual dialing. |
...
<Steps>
  <Step title="Build your agent">
    Use PearlVibe to define your agent's personality, knowledge base, conversation flow, and connected actions — all from a prompt-driven interface.
  </Step>
  <Step title="Deploy on a phone line">
    Assign a phone number and launch an inbound line or an outbound campaign. Your agent starts handling real calls immediately.
  </Step>
...
<Card title="PearlVibe" icon="wand-magic-sparkles" href="/pages/pearl_vibe">
  Design your agent's personality, knowledge, conversation flow, and actions — all from a single prompt-driven interface.
</Card>
