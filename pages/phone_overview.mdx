...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/phone-overview-cover.svg"
        alt="Phone Numbers Overview cover"
...
<Frame>
  <img
    src="/images/dark_mode/phone-numbers-display-name.png"
    alt="Editing a phone number's display name in the Phone Numbers list"
    className="rounded-[14px]"
  />
</Frame>
