...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/recording-cover.svg"
...
To add it to your flow, ask **PearlVibe** in natural language, in **Build** mode:
...
<Steps>
  <Step title="Disable automatic recording">
    ...
    <Frame>
      <img
        src="/images/dark_mode/recording-start-disabled-option.png"
  ...
  <Step title="Place the node">
    ...
    <Frame>
      <img
        src="/images/dark_mode/recording-node-example.png"
