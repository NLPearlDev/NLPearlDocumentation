...
Link the purchased phone number to the Pearl you want to use for handling onbound calls. This connects your conversational flow to real-world interactions.
