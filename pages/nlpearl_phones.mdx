...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/nlpearl-phones-cover.svg"
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/nlpearl-phones-select-number.png"
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/nlpearl-phones-purchase-popup.png"
        alt="Send Email action interface on light mode"
        className="rounded-[14px]"
      />
    </div>
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/nlpearl-phones-refresh-list.png"
        alt="Send Email action interface on light mode"
        className="rounded-[14px]"
      />
    </div>
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/nlpearl-phones-cart-summary.png"
        alt="Send Email action interface on light mode"
        className="rounded-[14px]"
      />
    </div>
