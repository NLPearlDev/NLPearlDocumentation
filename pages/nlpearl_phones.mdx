...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/phonenumberco23v.svg"
        alt="NLPearl Phone Numbers cover"
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/selectnlpearlphonenumber.png"
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/popupphonenumberpurchase.png"
        alt="Send Email action interface on light mode"
        className="rounded-[14px]"
      />
    </div>
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/refreshlistphonenumber.png"
        alt="Send Email action interface on light mode"
        className="rounded-[14px]"
      />
    </div>
...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/cartsummaryphone.png"
        alt="Send Email action interface on light mode"
        className="rounded-[14px]"
      />
    </div>
