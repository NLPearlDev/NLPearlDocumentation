...
6. **Conversationalist**: A fully open conversational model. Ready for any topic, including the bold. Always handled with nuance, control… and let’s be honest, not always politically correct.
...
1. **Agent Names, Languages & Voices**:
	...
	src="/images/light_mode/voices.png"
	alt="NLPearl.AI Logo Light"
	style={{ borderRadius: '18px' }}
	/>
	<img
	className="hidden dark:block"
	src="/images/dark_mode/voices.png"
...
4. **Indicator Tags**:
	<img
	className="block dark:hidden"
	src="/images/light_mode/tags.png"
	alt="NLPearl.AI Logo Light"
	style={{ borderRadius: '18px' }}
	/>
	<img
	className="hidden dark:block"
	src="/images/dark_mode/tags.png"
	alt="NLPearl.AI Logo Dark"
	style={{ borderRadius: '18px' }}
	/>
