...
description: "Go from sign-up to your first live AI agent in minutes."
icon: "rocket"
iconType: "light"
---
...
<Frame>
  <img
    src="/images/dark_mode/getting-started-signup.png"
    alt="NLPearl sign-up screen"
...
<Frame>
  <img
    src="/images/dark_mode/getting-started-dashboard.png"
    alt="NLPearl dashboard with the PearlVibe chat"
    className="rounded-[14px]"
  />
</Frame>
...
<Frame>
  <img
    src="/images/dark_mode/getting-started-test-call.png"
    alt="Run a test call from the platform"
    className="rounded-[14px]"
  />
</Frame>
...
<Frame>
  <img
    src="/images/dark_mode/getting-started-billing.png"
    alt="Subscription plans in Subscriptions & Payments"
    className="rounded-[14px]"
  />
</Frame>
