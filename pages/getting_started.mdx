...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/light_mode/getting_started-cover.png"
        alt="NLPearl platform home page on light mode"
...
<div className="hidden dark:block">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/getting_started-cover.png"
        alt="NLPearl platform home page on dark mode"
        className="rounded-[14px]"
      />
    </div>
  </Frame>
