---
title: "API Action"
description: "Configure API actions in PearlVibe to fetch or update data during a live conversation."
icon: "code"
iconType: "light"
---
...
1. How API Actions work in PearlVibe
...
<Info>
  Add an **API node** inside the conversation tree. As soon as the flow reaches that node, the request runs automatically.
</Info>
