...
<Steps>
  <Step title="Open Numbers & senders">
    ...
    <Frame>
      <img src="/images/dark_mode/sms_numbers_menu.png" alt="Open Numbers & senders in the Twilio Console" className="rounded-[14px] w-full" />
    </Frame>
  </Step>
  <Step title="Set up a new phone number">
    ...
    <Frame>
      <img src="/images/dark_mode/sms_setup_number.png" alt="Set up a new phone number from the Phone Numbers tab" className="rounded-[14px] w-full" />
    </Frame>
  </Step>
  <Step title="Select an SMS-enabled number">
    ...
    <Frame>
      <img src="/images/dark_mode/sms_select_sms.png" alt="Select a phone number with SMS capability enabled" className="rounded-[14px] w-full" />
    </Frame>
  </Step>
</Steps>
