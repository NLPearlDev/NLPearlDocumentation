...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/telegramcovooo.svg"
        alt="Telegram cover"
...
<Steps>
  ...
  <Step title="Find BotFather">
    ...
    <Frame>
      <div className="block dark:hidden">
        <img src="/images/light_mode/telegram_search.png" alt="Searching for BotFather in Telegram" className="rounded-[14px] w-full" />
      </div>
      <div className="hidden dark:block">
        <img src="/images/dark_mode/telegram_search.png" alt="Searching for BotFather in Telegram" className="rounded-[14px] w-full" />
      </div>
    </Frame>
  </Step>
  <Step title="Start the conversation">
    ...
    <Frame>
      <div className="block dark:hidden">
        <img src="/images/light_mode/telegram_start.png" alt="BotFather /start command" className="rounded-[14px] w-full" />
      </div>
      <div className="hidden dark:block">
        <img src="/images/dark_mode/telegram_start.png" alt="BotFather /start command" className="rounded-[14px] w-full" />
      </div>
    </Frame>
  </Step>
  <Step title="Create a new bot">
    ...
    <Frame>
      <div className="block dark:hidden">
        <img src="/images/light_mode/telegram_newbot.png" alt="BotFather /newbot command and bot name" className="rounded-[14px] w-full" />
      </div>
      <div className="hidden dark:block">
        <img src="/images/dark_mode/telegram_newbot.png" alt="BotFather /newbot command and bot name" className="rounded-[14px] w-full" />
      </div>
    </Frame>
  </Step>
  <Step title="Save your token">
    ...
    <Frame>
      <div className="block dark:hidden">
        <img src="/images/light_mode/telegram_token.png" alt="BotFather bot creation confirmation and token" className="rounded-[14px] w-full" />
      </div>
      <div className="hidden dark:block">
        <img src="/images/dark_mode/telegram_token.png" alt="BotFather bot creation confirmation and token" className="rounded-[14px] w-full" />
      </div>
    </Frame>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Connect to Telegram">
    ...
    <Frame>
      <div className="block dark:hidden">
        <img src="/images/light_mode/telegram_connect.png" alt="Connect Telegram from the Text Channels page" className="rounded-[14px] w-full" />
      </div>
      <div className="hidden dark:block">
        <img src="/images/dark_mode/telegram_connect.png" alt="Connect Telegram from the Text Channels page" className="rounded-[14px] w-full" />
      </div>
    </Frame>
  </Step>
  <Step title="Enter the bot details">
    ...
    <Frame>
      <div className="block dark:hidden">
        <img src="/images/light_mode/telegram_connect_modal.png" alt="Connect Telegram dialog with bot token and channel name" className="rounded-[14px] w-full" />
      </div>
      <div className="hidden dark:block">
        <img src="/images/dark_mode/telegram_connect_modal.png" alt="Connect Telegram dialog with bot token and channel name" className="rounded-[14px] w-full" />
      </div>
    </Frame>
  </Step>
  ...
  <Step title="Assign the channel to a Pearl">
    ...
    <Frame>
      <div className="block dark:hidden">
        <img src="/images/light_mode/telegram_assign_pearl.png" alt="Assign the Telegram channel to a Pearl from its settings" className="rounded-[14px] w-full" />
      </div>
      <div className="hidden dark:block">
        <img src="/images/dark_mode/telegram_assign_pearl.png" alt="Assign the Telegram channel to a Pearl from its settings" className="rounded-[14px] w-full" />
      </div>
    </Frame>
  </Step>
</Steps>
