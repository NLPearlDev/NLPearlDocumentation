...
Ask PearlVibe to create a Pearl for your inbound text use case. Describe the channel, tone, expected questions, handoff rules, and any tools Pearl should use. When the Pearl is ready, publish it.
...
After publishing the Pearl, open its overview page and connect the messaging channel your customers will use.
