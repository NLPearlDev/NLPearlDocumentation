...
<div className="block dark:hidden">
  <Frame>
    <div className="p-1">
      <img
        src="/images/light_mode/pearl_text-cover.png"
...
<div className="hidden dark:block">
  <Frame>
    <div className="p-1">
      <img
        src="/images/dark_mode/pearl_text-cover.png"
        alt="Pearl Text cover"
        className="rounded-[14px]"
      />
    </div>
...
<Info>
Pearl Text does not require language or voice setup like Pearl Voice. Text agents can handle written conversations in any language.
</Info>
