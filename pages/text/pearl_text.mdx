...
<Steps>
  ...
  <Step title="Connect your channels" icon="comments">
    Deploy your agent on [inbound](/pages/text/inbound) channels to answer messages instantly, or launch [outbound](/pages/text/outbound) campaigns to reach customers across [SMS](/pages/text/channels/sms), [WhatsApp](/pages/text/channels/whatsapp), email, and chat.
  </Step>
