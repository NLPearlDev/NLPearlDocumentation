...
1. **Flow Example Using the Pre-Call API**  
   ![Flow Example Using Pre-Call API](/images/exemples/api-pre-call-tree.png "Flow Example Using Pre-Call API")
...
<img src="/images/exemples/api-pre-call-settings.png" alt="Pre-Call API Configuration Panel" width="50%" height="50%" />
