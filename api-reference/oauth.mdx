...
<Steps>
  <Step title="Open the API Access page">
    ...
    <Frame>
      <img
        src="/images/dark_mode/oauth-api-access-page.png"
        alt="API Access page with the Create OAuth 2.0 App button"
...
<Step title="Add OAuth 2.0 App">
  ...
  **Scopes** it is allowed to use.
  ...
  <Frame>
    <img
      src="/images/dark_mode/oauth-create-app.png"
      alt="Create OAuth 2.0 App dialog"
      className="rounded-[14px]"
    />
  </Frame>
</Step>
...
<Frame>
  <img
    src="/images/dark_mode/oauth-edit-scopes.png"
    alt="Edit OAuth 2.0 App scopes"
    className="rounded-[14px]"
  />
</Frame>
